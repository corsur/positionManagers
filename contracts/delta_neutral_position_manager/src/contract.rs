...
pub fn open_position(
    ...
    response = response.add_submessage(SubMsg {
        ...
        msg: WasmMsg::Instantiate {
            admin: None,
            code_id: 123,
            msg: to_binary(&aperture_common::delta_neutral::InstantiateMsg {
    ...
    response = response.add_message(CosmosMsg::Wasm(WasmMsg::Execute {
        ...
        msg: to_binary(
            &aperture_common::delta_neutral::ExecuteMsg::DeltaNeutralInvest {
...
pub fn increase_position(token: TokenInfo, params: DeltaNeutralParams) -> StdResult<Response> {
    Ok(Response::default())
}

pub fn decrease_position(token: TokenInfo, params: DeltaNeutralParams) -> StdResult<Response> {
    Ok(Response::default())
}

pub fn close_position(token: TokenInfo, params: DeltaNeutralParams) -> StdResult<Response> {
    Ok(Response::default())
}
